...
const UI = {
  ja: {
    ...
    heroBody: '日本全国の求人を日本語・ベトナム語で紹介。LINEで簡単登録。',
  ...
  vi: {
    ...
    heroBody: 'Thông tin việc làm toàn Nhật bằng tiếng Nhật & Việt. Đăng ký dễ dàng qua LINE.',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-cyan-50 to-white text-slate-800">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-4 right-4 md:bottom-6 md:right-6 rounded-full shadow-lg bg-teal-600 hover:bg-teal-700 text-white px-4 py-3 inline-flex items-center gap-2"
      >
        <MessageSquare className="h-5 w-5" /> {t.lineCta}
      </a>
