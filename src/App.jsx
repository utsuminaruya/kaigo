...
function generateSampleJobs(n = 20) {
  ...
  for (let i = 1; i <= n; i++) {
    ...
    arr.push({
      ...
      areaPref: p.areaPref,
      region: p.region,
      tags: ['介護', i % 3 ? '正社員' : 'パート', i % 2 ? 'JLPT N3' : 'JLPT N2', i % 4 ? '寮あり' : '日勤のみ', 'ビザ支援あり'],
...
const UI = {
  ja: {
    ...
    heroBody: '日本全国の求人を日本語・ベトナム語で紹介。LINE / Messengerで簡単相談。',
    searchPlaceholder: 'キーワード例: 介護, N3, 寮あり, 夜勤',
    visaFriendly: 'ビザ支援あり',
    salary: '給与',
    city: '勤務地',
    area: 'エリア',
  ...
  vi: {
    ...
    heroBody: 'Việc làm toàn Nhật bằng tiếng Nhật & Việt. Tư vấn nhanh qua LINE / Messenger.',
    searchPlaceholder: 'Từ khóa: Kaigo, N3, ký túc, ca đêm',
    visaFriendly: 'Hỗ trợ visa',
    salary: 'Lương',
    city: 'Nơi làm việc',
    area: 'Khu vực',
    region: 'Vùng',
    lineCta: 'Tư vấn qua LINE',
    lineCtaApply: 'Ứng tuyển/Tư vấn LINE',
    msgrCta: 'Messenger',
              ...
              <div className="p-5 border-b border-slate-200">
                <div className="text-lg font-bold flex items-center justify-between text-slate-900">
                  ...
                  <div className="flex items-center gap-2">
                    {j.sample && (
                      <span className="rounded-xl px-2 py-1 text-xs bg-amber-50 text-amber-700 border border-amber-200">
                        {t.sample}
                      </span>
                    )}
                    {j.visa_friendly && (
